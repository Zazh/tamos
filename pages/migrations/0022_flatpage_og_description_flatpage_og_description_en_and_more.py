# Generated by Django 5.2.14 on 2026-05-19 00:21
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('pages', '0021_cleanup_inactive_region_flatpages'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='flatpage',
            name='og_image',
            field=models.ImageField(blank=True, help_text='1200×630 для соцсетей. Если пусто — fallback на обложку страницы.', null=True, upload_to='pages/flat/og/', verbose_name='OG/share картинка'),
        ),
        migrations.AddField(
            model_name='flatpage',
            name='og_title',
